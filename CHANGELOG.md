...
---
## [第二十八轮] — v5.19 — 2026-08-27 回答级证据链

### 变更

- 新增回答级“证据链”入口，展示研究结论与当前回答真实来源之间的关系。
- 正文 `[来源N]` 与当前消息来源严格交集映射，支持点击来源定位现有证据面板。
- 新增响应式和可访问性样式；未新增后端接口、图表关联或历史证据关系。

### 验证

- 前端 Vitest：44 个文件、235 项通过。
- oxlint 通过；`tsc -b && vite build` 通过。
- 后端全量：186 passed，1 skipped。
